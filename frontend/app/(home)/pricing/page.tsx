    ...
    <>
      <section className="max-w-7xl mx-auto text-center mb-16">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Choose a plan that grows with your team. From individual coaches to
          large organizations, we have a solution tailored to your needs.
        </p>
      ...
      <section className="grid md:grid-cols-4 gap-8 max-w-7xl mx-auto">
        {pricingTiers.map((tier) => (
          <div
            key={tier.name}
            className={`
                bg-white rounded-xl shadow-lg p-6 border
                ${
                  tier.featured
      ...
      <section className="max-w-7xl mx-auto mt-16 text-center bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-12">
        <h2 className="text-3xl font-bold mb-6 text-primary">
          Need a Custom Solution?
        </h2>
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
          Every team is unique. Our enterprise solutions are tailored to meet
          your specific sports management requirements.
        </p>
