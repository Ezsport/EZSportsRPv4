...
export default function FeaturesPage() {
  const featureCategories = [
    {
      ...
      description:
        "Comprehensive tools to streamline team operations and communication.",
      features: [
        {
          name: "Roster Management",
          description:
            "Easily add, remove, and track team members with detailed profiles.",
          icon: <Clipboard className="w-6 h-6 text-primary mr-3" />,
        },
        {
          name: "Communication Hub",
          description:
            "Centralized messaging and notification system for seamless team interaction.",
          icon: <Zap className="w-6 h-6 text-primary mr-3" />,
        },
        {
          name: "Role-Based Access",
          description:
            "Customize access levels for coaches, players, managers, and staff.",
    ...
    },
    {
      ...
      description:
        "Advanced tracking and analysis to enhance individual and team performance.",
      features: [
        {
          name: "Player Metrics",
        ...
        },
        {
          ...
          description:
            "Compare player and team performance across multiple dimensions.",
    ...
    },
    {
      ...
      description:
        "Comprehensive scheduling tools for games, practices, and team events.",
      features: [
        {
          name: "Game Scheduling",
          description:
            "Automated scheduling with conflict resolution and venue management.",
          icon: <Briefcase className="w-6 h-6 text-primary mr-3" />,
        },
        {
          name: "Training Planner",
          description:
            "Create and track training sessions with detailed workout plans.",
          icon: <Calendar className="w-6 h-6 text-primary mr-3" />,
        },
        {
          name: "Resource Allocation",
          description:
            "Optimize field, equipment, and staff resources efficiently.",
          icon: <Layers className="w-6 h-6 text-primary mr-3" />,
        },
      ],
    },
  ...
  const additionalFeatures = [
    {
      ...
      description:
        "Generate detailed reports on team and individual performance.",
  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto bg-muted/5 py-16">
        <div className="container mx-auto text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 text-primary">
            Additional Platform Capabilities
          </h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Beyond core features, EZSports RP offers a range of advanced tools
            to support your sports management needs.
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto bg-gradient-to-br from-primary/10 to-primary/5 py-16 text-center">
