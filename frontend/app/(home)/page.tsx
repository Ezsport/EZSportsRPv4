...
export default function Home() {
  return (
    <>
      <section
        className="relative mx-auto bg-cover bg-center bg-no-repeat overflow-hidden m-0 py-8"
        style={{
          backgroundImage:
      ...
      >
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center gap-8 p-8 lg:p-16">
          <div className="space-y-6 z-10 relative text-left">
            ...
            <p className="text-xl text-white/90 drop-shadow-md ">
              The all-in-one platform for coaches, team managers, and referees.
              Streamline operations, analyze performance, and focus on what
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 bg-muted/10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white shadow-lg rounded-xl p-6 text-center hover:shadow-xl transition-all">
            ...
            <p className="text-muted-foreground">
              Detailed analytics and performance metrics for players and teams.
            </p>
          </div>
          <div className="bg-white shadow-lg rounded-xl p-6 text-center hover:shadow-xl transition-all">
            <div className="mb-4 flex justify-center">
      ...
      <section className="max-w-7xl mx-auto bg-gradient-to-br from-primary/10 to-primary/5 py-16">
