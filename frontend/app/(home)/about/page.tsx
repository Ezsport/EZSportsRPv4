  ...
  const coreValues = [
    {
      ...
      title: "Excellence",
      description:
        "Committed to delivering top-tier sports management solutions that empower teams to achieve their full potential.",
    },
    {
      icon: <Users className="w-12 h-12 text-primary" />,
      title: "Collaboration",
      description:
        "Believing in the power of teamwork, both in sports and in our approach to technology and customer support.",
    },
    {
      icon: <Target className="w-12 h-12 text-primary" />,
      title: "Innovation",
      description:
        "Continuously pushing boundaries to create cutting-edge tools that transform sports management.",
    },
    {
      icon: <Globe className="w-12 h-12 text-primary" />,
      title: "Accessibility",
      description:
        "Making advanced sports management technology available to teams of all sizes and levels.",
    },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl text-muted-foreground mb-4">
              Founded in 2022, EZSports RP emerged from the frustration of
              coaches and team managers struggling with fragmented management
              tools.
            </p>
            <p className="text-lg text-muted-foreground">
              ...
              enhances team performance, and brings technology and sports
              together.
            </p>
          </div>
          <div>
      ...
      <section className="max-w-7xl mx-auto bg-muted/5 py-16">
        <div className="container mx-auto text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            The principles that drive our innovation and commitment to sports
            management.
          </p>
        </div>
